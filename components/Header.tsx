        ...
        <div className="flex justify-between items-center h-20"> {/* Increased height for two lines of text */}
          <div className="flex-shrink-0">
            <a href="#" className="flex items-center">
              <img src="https://ik.imagekit.io/lmpdfv6pk/WhatsApp%20Image%202023-02-20%20at%2021.56.07.jpeg?updatedAt=1749420232079" alt="Lycpersonalizadas Logo - Expertos en Gorras Trucker Personalizadas" className="h-12 w-auto" /> {/* Slightly larger logo, updated alt text */}
